  ...
  return (
    <div className="row py-5">
      ...
      <div className="row gap-4 mx-auto btn-width">
          <button className="btn btn-primary px-4 fsize"><a className="button-link" href="https://oluwacyna-form-validation.netlify.app/" target="_blank">View Live</a></button>
          <button className="btn btn-primary px-4 fsize"><a className="button-link" href="https://github.com/oluwaCyna/Form-Validation" target="_blank">GitHub Repo</a></button>
      </div>
    </div>
  )
}
