  ...
  return (
    <div className="row py-5">
      ...
      <div className="row gap-4 mx-auto btn-width">
          <a className="btn btn-primary px-4 fsize button-link" href="https://oluwacyna-real-estate-agent.netlify.app/" target="_blank">View Live</a>
          <a className="btn btn-primary px-4 fsize button-link" href="https://github.com/oluwaCyna/Real-Estate-Agent-" target="_blank">GitHub Repo</a>
      </div>
    </div>
  )
}
