  ...
  return (
    <div className="row py-5">
      ...
      <div className="row gap-4 mx-auto btn-width">
          <a className="btn btn-primary px-4 fsize button-link" href="https://cerulean-gecko-790125.netlify.app/" target="_blank">View Live</a>
          <a className="btn btn-primary px-4 fsize button-link" href="https://github.com/oluwaCyna/Dictionary" target="_blank">GitHub Repo</a>
      </div>
    </div>
  )
}
